"""scheduler service - Fase 1 skeleton (sin logica de negocio).

Responsabilidad (docs/ARCHITECTURE.md seccion 3): Cron de reentrenamiento, reoptimizacion, jobs periodicos
"""
