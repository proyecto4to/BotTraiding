"""execution-engine service - Fase 1 skeleton (sin logica de negocio).

Responsabilidad (docs/ARCHITECTURE.md seccion 3): Convierte Order aprobada en ordenes de broker, reintentos, confirmacion
"""
